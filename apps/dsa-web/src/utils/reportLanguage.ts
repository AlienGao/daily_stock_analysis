...
const REPORT_TEXT = {
  zh: {
    ...
    takeProfit: '止盈目标',
    noValue: '—',
    matchedSkillsEyebrow: '策略命中',
    matchedSkillsTitle: '命中交易技能',
    matchedSkillsPrimary: '主命中',
    matchedSkillsConfidence: '置信度',
    matchedSkillsReason: '命中依据',
    matchedSkillsConditions: '命中条件',
    matchedSkillsEmpty: '本次未命中任何激活技能',
    newsFeed: '资讯动态',
    relatedNews: '相关资讯',
    refresh: '刷新',
    retry: '重试',
  ...
  en: {
    ...
    noValue: '—',
    matchedSkillsEyebrow: 'STRATEGY MATCH',
    matchedSkillsTitle: 'Matched Trading Skills',
    matchedSkillsPrimary: 'Primary',
    matchedSkillsConfidence: 'Confidence',
    matchedSkillsReason: 'Evidence',
    matchedSkillsConditions: 'Conditions',
    matchedSkillsEmpty: 'No activated skill triggered this run',
    newsFeed: 'NEWS FEED',
