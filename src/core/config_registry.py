...
_CATEGORY_DEFINITIONS: List[Dict[str, Any]] = [
    ...
    },
    {
        ...
        "description": "Auto-discovery engine factor weights and scanner settings.",
        "display_order": 45,
    },
    {
...
_FIELD_DEFINITIONS: Dict[str, Dict[str, Any]] = {
    ...
    "BACKTEST_AUTO_MODE": {
        "title": "Backtest Auto Mode",
        "description": "Auto-backtest behavior after daily analysis.",
        "category": "backtest",
        "data_type": "string",
        "ui_control": "select",
        "is_sensitive": False,
        ...
        "options": [
            ...
            {"value": "previous_trading_day_buy_hold", "label": "previous_trading_day_buy_hold"},
        ],
        "validation": {},
        "display_order": 60,
    },
    "BACKTEST_AUTO_FILTER_MODE": {
        "title": "Backtest Auto Filter Mode",
        "description": "Auto-backtest candidate filter mode: all / signal / score / signal_and_score.",
        "category": "backtest",
        "data_type": "string",
        "ui_control": "select",
        "is_sensitive": False,
        ...
        "options": [
            ...
            {"value": "signal_and_score", "label": "signal_and_score"},
        ],
        "validation": {},
        "display_order": 65,
    },
    "BACKTEST_AUTO_ALLOWED_CATEGORIES": {
        "title": "Backtest Auto Allowed Categories",
        "description": "Comma-separated advice categories for auto mode (e.g. BUY,HOLD).",
        "category": "backtest",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
        "is_required": False,
        "is_editable": True,
        "default_value": "BUY,HOLD",
        "options": [],
        "validation": {},
        "display_order": 70,
    },
    "BACKTEST_AUTO_SENTIMENT_SCORE_MIN": {
        "title": "Backtest Auto Min Score",
        "description": "Minimum sentiment score for auto-backtest filtering (0-100).",
        "category": "backtest",
        "data_type": "integer",
        "ui_control": "number",
        "is_sensitive": False,
    ...
    "BACKTEST_AUTO_SENTIMENT_SCORE_MAX": {
        "title": "Backtest Auto Max Score",
        "description": "Maximum sentiment score for auto-backtest filtering (0-100).",
        "category": "backtest",
        "data_type": "integer",
        "ui_control": "number",
        "is_sensitive": False,
    ...
    "TOP_N_MULTI_AGENT_REVIEW_ENABLED": {
        "title": "Top-N Multi-Agent Review",
        "description": "After the batch run, re-analyse the top-N stocks by sentiment with AGENT_ARCH=multi, merge if rating category differs, then write the daily report + notifications.",
        "category": "agent",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
    ...
    "TOP_N_MULTI_AGENT_REVIEW_COUNT": {
        "title": "Top-N Count",
        "description": "How many top sentiment-score stocks to re-run with multi-agent.",
        "category": "agent",
        "data_type": "integer",
        "ui_control": "number",
        "is_sensitive": False,
    ...
    "TOP_N_MULTI_AGENT_REVIEW_MODE": {
        "title": "Top-N Orchestrator Mode",
        "description": "Orchestrator mode for the multi-agent recheck (same as AGENT_ORCHESTRATOR_MODE).",
        "category": "agent",
        "data_type": "string",
        "ui_control": "select",
        "is_sensitive": False,
        ...
        "validation": {"enum": ["quick", "standard", "full", "specialist"]},
        "display_order": 58,
    },
    "TOP_N_MULTI_AGENT_REVIEW_SCHEDULE": {
        "title": "Top-N Schedule",
        "description": "after_batch/both: run multi when batch ends. close=CN 14:00+; open=before 13:00; close/open are evaluated at batch **end** time (+8h), not job start time.",
        "category": "agent",
        "data_type": "string",
        "ui_control": "select",
        "is_sensitive": False,
        "is_required": False,
        "is_editable": True,
        "default_value": "after_batch",
        "options": [
            {"label": "After each batch", "value": "after_batch"},
            {"label": "Both sessions (legacy)", "value": "both"},
            {"label": "Close session", "value": "close"},
            {"label": "Open session", "value": "open"},
        ],
        "validation": {"enum": ["after_batch", "both", "close", "open"]},
        "display_order": 59,
    },
    "TOP_N_MULTI_AGENT_REVIEW_CONCURRENCY": {
        "title": "Top-N Concurrency",
        "description": "Parallel workers for multi-agent rechecks.",
        "category": "agent",
        "data_type": "integer",
        "ui_control": "number",
        "is_sensitive": False,
    ...
    "TOP_N_MULTI_AGENT_REVIEW_OUTPUT_DIR": {
        "title": "Top-N Appendix Directory",
        "description": "Directory for report_multi_YYYYMMDD.md appendix files.",
        "category": "agent",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
        "is_required": False,
        "is_editable": True,
        "default_value": "reports_multi_agent",
        "options": [],
        "validation": {},
        "display_order": 61,
    },
    "HOME_ANALYSIS_REPORTS_DIR": {
        "title": "Home / API Single-Stock Report Directory",
        "description": "Root directory for per-code Markdown snapshots from home page or async API (reports_temp/YYYY-MM-DD/CODE.md).",
        "category": "system",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
    ...
    "AUTO_DISCOVER": {
        "title": "Auto Discover",
        "description": "Enable stock auto-discovery engine. When enabled, the system discovers stocks automatically instead of using a fixed STOCK_LIST.",
        "category": "discovery",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
    ...
    "AUTO_DISCOVER_COUNT": {
        ...
        "description": "Number of stocks to recommend per discovery run (1-50).",
        "category": "discovery",
        "data_type": "integer",
        "ui_control": "number",
        "is_sensitive": False,
    ...
    "DISCOVER_WEIGHT_SECTOR": {
        "title": "Sector Weight (Intraday)",
        "description": "Weight for sector heat factor in intraday scanning (0-100).",
        "category": "discovery",
        "data_type": "number",
        "ui_control": "number",
        "is_sensitive": False,
    ...
    "DISCOVER_WEIGHT_MA_ENTRY": {
        "title": "MA Entry Weight (Intraday)",
        "description": "Weight for moving average entry factor — the core intraday factor (0-100).",
        "category": "discovery",
        "data_type": "number",
        "ui_control": "number",
        "is_sensitive": False,
    ...
    "DISCOVER_WEIGHT_MOMENTUM": {
        "title": "Momentum Weight (Intraday)",
        "description": "Weight for momentum/breakout factor in intraday scanning (0-100).",
        "category": "discovery",
        "data_type": "number",
        "ui_control": "number",
        "is_sensitive": False,
    ...
    "DISCOVER_WEIGHT_REBOUND": {
        "title": "Rebound Weight (Intraday)",
        "description": "Weight for limit-up rebound factor in intraday scanning (0-100).",
        "category": "discovery",
        "data_type": "number",
        "ui_control": "number",
        "is_sensitive": False,
    ...
    "DISCOVER_WEIGHT_MONEYFLOW": {
        "title": "Money Flow Weight (Post-market)",
        "description": "Weight for money flow factor in post-market deep analysis (0-100).",
        "category": "discovery",
        "data_type": "number",
        "ui_control": "number",
        "is_sensitive": False,
    ...
    "DISCOVER_WEIGHT_MARGIN": {
        "title": "Margin Weight (Post-market)",
        "description": "Weight for margin trading factor (T+1 data) in post-market analysis (0-100).",
        "category": "discovery",
        "data_type": "number",
        "ui_control": "number",
        "is_sensitive": False,
    ...
    "DISCOVER_WEIGHT_CHIP": {
        "title": "Chip Weight (Post-market)",
        "description": "Weight for chip structure / winner rate factor in post-market analysis (0-100).",
        "category": "discovery",
        "data_type": "number",
        "ui_control": "number",
        "is_sensitive": False,
    ...
    "DISCOVER_WEIGHT_TECHNICAL": {
        "title": "Technical Weight (Post-market)",
        "description": "Weight for technical factor (stk_factor: MACD/RSI/KDJ/BOLL) in post-market analysis (0-100).",
        "category": "discovery",
        "data_type": "number",
        "ui_control": "number",
        "is_sensitive": False,
    ...
    "DISCOVER_WEIGHT_LIMIT_POST": {
        "title": "Limit Weight (Post-market)",
        "description": "Weight for limit-up/down factor in post-market analysis (0-100).",
        "category": "discovery",
        "data_type": "number",
        "ui_control": "number",
        "is_sensitive": False,
    ...
    "DISCOVER_SCAN_INTERVAL": {
        ...
        "description": "Intraday polling interval in seconds (30-3600).",
        "category": "discovery",
        "data_type": "integer",
        "ui_control": "number",
        "is_sensitive": False,
    ...
    "DISCOVER_SCAN_MAX_RUNTIME": {
        "title": "Max Runtime (min)",
        "description": "Maximum intraday scan runtime in minutes (30-480).",
        "category": "discovery",
        "data_type": "integer",
        "ui_control": "number",
        "is_sensitive": False,
    ...
    "DISCOVER_SCAN_TOP_N": {
        "title": "Scan Top N",
        "description": "Number of stocks to keep in the intraday top-N list (1-30).",
        "category": "discovery",
        "data_type": "integer",
        "ui_control": "number",
        "is_sensitive": False,
